...
public class RouteOverlay {
	...
	protected BitmapDescriptor getStartBitmapDescriptor() {
		return BitmapDescriptorFactory.fromResource(R.drawable.ic_baseline_my_location_24);
	}
	/**
	...
	protected BitmapDescriptor getEndBitmapDescriptor() {
		return BitmapDescriptorFactory.fromResource(R.drawable.ic_baseline_location_searching_24);
	}
	/**
...
//				.title("\u8D77\u70B9"));
	...
	protected int getWalkColor() {
		return Color.parseColor("#2A59E3");
	}
